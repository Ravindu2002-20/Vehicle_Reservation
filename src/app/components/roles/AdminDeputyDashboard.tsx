        ...
        <CardContent className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              <div
                key={i}
                className="p-4 bg-gradient-to-br from-teal-50 to-white rounded-lg border border-teal-100 hover:shadow-md transition-shadow"
              >
              ...
              {[
                ...
                <div
                  ...
                  className={`flex items-center justify-between p-3 rounded-lg ${
                    day.highlight ? "bg-purple-100" : "bg-gray-50"
                  }`}
                >
                  <div className="flex items-center gap-3">
                    <div
                      className={`w-2 h-2 rounded-full ${
                        day.highlight ? "bg-purple-600" : "bg-gray-400"
                      }`}
                    />
