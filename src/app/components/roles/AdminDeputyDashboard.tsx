...
export function AdminDeputyDashboard({ currentPage }: { currentPage?: string }) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-gray-800">General Admin Dashboard</h1>

        <p className="text-gray-600 mt-2">Executive overview of faculty vehicle management</p>
      </div>

      {/* University-Wide Stats (Dean-style) */}
      ...
      {/* Ongoing Request (General Admin: only Dean-approved) */}
      <div className="pt-4">
        <OngoingRequestsView stage="general-admin-dean-approved" />
      </div>
